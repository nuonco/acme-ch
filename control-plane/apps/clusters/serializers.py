...
class CHClusterStatusSerializer(serializers.Serializer):
    ...
    status = serializers.ChoiceField(
        choices=CHClusterStatus.STATUS_CHOICES,
        default=CHClusterStatus.STATUS_PENDING
    )
...
class CHClusterSerializer(serializers.ModelSerializer):
    ...
    ingress_type_display = serializers.CharField(source='get_ingress_type_display', read_only=True)
